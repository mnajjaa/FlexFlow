...
//
//public class DashbordEvenement extends Application {
//
//
//
//    // Autres déclarations
...
//        FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("dashbordEvenement.fxml"));
...
//
//        TableColumn<Evenement, java.sql.Date> DateColumn = new TableColumn<>("Date");
...
//                statement.setDate(5, java.sql.Date.valueOf(DateField.getValue()));
